  ...
  return (
    <Sheet>
      ...
      <SheetContent>
        ...
        <div className="mt-4 space-y-4">
          <p>
            <strong>User:</strong> {feedback?.userId?.firstName || "Unknown"}
          </p>
          <p>
            <strong>Email:</strong> {feedback?.userId?.email || "Unknown"}
          </p>
          <p>
            <strong>Feedback:</strong> {feedback?.feedback || "No feedback provided"}
          </p>
          <h3 className="text-lg font-semibold">Products</h3>
          {isLoading ? (
            <p>Loading products...</p>
            ...
            <p>No products found for this feedback.</p>
          )}
        </div>
      </SheetContent>
    </Sheet>
