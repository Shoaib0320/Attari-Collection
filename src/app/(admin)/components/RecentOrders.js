...
// // // //   const orders = [
// // // //     { id: "#1234", customer: "John Doe", product: "T-Shirt", total: "$25.99", status: "Delivered" },
// // // //     { id: "#1235", customer: "Jane Smith", product: "Jeans", total: "$59.99", status: "Processing" },
// // // //     { id: "#1236", customer: "Bob Johnson", product: "Sneakers", total: "$89.99", status: "Shipped" },
// // // //     { id: "#1237", customer: "Alice Brown", product: "Dress", total: "$79.99", status: "Pending" },
// // // //   ];
...
// // // //                 <TableCell className="text-gray-200">{order.id}</TableCell>
// // // //                 <TableCell className="text-gray-200">{order.customer}</TableCell>
// // // //                 <TableCell className="text-gray-200">{order.product}</TableCell>
// // // //                 <TableCell className="text-gray-200">{order.total}</TableCell>
...
// // //     <Card className="col-span-1 md:col-span-2 bg-gradient-to-r from-gray-800 to-gray-900 shadow-md hover:shadow-lg">
// // //       <CardHeader>
// // //         <CardTitle className="text-gray-100">Today's Orders</CardTitle>
// // //       </CardHeader>
// // //       <CardContent>
// // //         <Table>
// // //           <TableHeader>
...
// // //                 <TableCell className="text-gray-200">{order.title}</TableCell>
// // //                 <TableCell className='text-gray-200'>{new Date(order.createdAt).toLocaleString()}</TableCell>
// // //                 <TableCell className="text-gray-200">${order.totalAmount}</TableCell>
// // //                 <TableCell className="text-gray-200">{order.status}</TableCell>
// // //               </TableRow>
// // //             ))}
// // //           </TableBody>
...
//               <TableRow key={order._id}>
//                 <TableCell className="text-gray-200">{order._id.substring(0, 8)}</TableCell>
//                 <TableCell className="text-gray-200">{order.customerName}</TableCell>
//                 <TableCell className="text-gray-200">{order.productName}</TableCell>
//                 <TableCell className="text-gray-200">PKR{order.totalAmount}</TableCell>
//                 <TableCell className="text-gray-200">{order.status}</TableCell>
//               </TableRow>
//             ))}
//           </TableBody>
