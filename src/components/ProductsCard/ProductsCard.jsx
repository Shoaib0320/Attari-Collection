...
// // // //         <Button className="flex justify-center items-center mx-auto my-10" onClick={fetchProducts}>Retry</Button>
// // // //       </div>
// // // //     )
// // // //   }
...
//       <div>
//         <p className="flex justify-center items-center">Error fetching products: {error}</p>
//         <Button className="flex justify-center items-center mx-auto my-10" onClick={loadProducts}>Retry</Button>
//       </div>
//     )
//   }
